...
class TestExchangeFIRSTPLAY:
    """Tests for exchange effect (defense GameAction)."""
    ...
    def test_exchange_effect(self):
        ...
        assert str(
            ...
            GameAction(
                action=ActionType.ASK_DEFENSE, target=[2], defense_cards=[]
            )
        )
    ...
    def test_exchange_effect_without_target(self):
        ...
        with pytest.raises(ValueError):
            do_effect(id_game=1, id_player=1, id_card_type=32, first_play=True)
