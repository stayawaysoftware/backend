...
class TestWhisky:
    ...
    def setup_method(self):
        ...
        draw_specific(id_game=1, id_player=1, idtype_card=8)
    ...
    def teardown_method(self):
        ...
        discard(id_game=1, id_player=1, idtype_card=8)
    ...
    @db_session
    def test_whisky_effect_with_dead_player(self):
        """Test whisky effect with dead player."""
